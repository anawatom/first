...
// Field names
// ATTACH_ID       NOT NULL,
// ATTACH_SUBJECT  VARCHAR2(255 BYTE),
// ATTACH_PATH     VARCHAR2(4000 BYTE),
// TERM_ID         NUMBER(38),
// ATTACH_STATUS   NUMBER(1),
// ATTACH_SIZE     NUMBER(38),
// CREATE_DATE     TIMESTAMP(6),
// CREATE_BY       VARCHAR2(20 BYTE),
// UPDATE_DATE     TIMESTAMP(6),
// UPDATE_BY       VARCHAR2(20 BYTE),
// VERSION         NUMBER(8)
class model_gms_term_attach extends CI_Model {
	...
	public function __construct() 
	{
		...
		$this->table_name = 'GMS_TERM_ATTACH';
		$this->primary_key = 'ATTACH_ID';
	}
	...
	public function get_by_term_id($term_id, $order_field = 'ATTACH_ID', $order_type = 'ASC')
	{
	...
	public function fetch_data($limit = '0', $offset = '0', $order_field = 'ATTACH_ID', $order_type = 'ASC')
	{
		$this->db->from($this->table_name);
		$this->db->order_by($order_field, $order_type);
	...
	// public function search($params, $limit = '0', $offset = '0', $order_field = 'ATTACH_ID', $order_type = 'ASC')
	// {
	// 	$this->db->from($this->table_name);
	// 	$this->add_search_conditions($params);
	// 	$this->db->order_by($order_field, $order_type);
