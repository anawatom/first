...
// Field names
// DI_PROD_ID    NUMBER(15)
// MEMBER_ID     NUMBER(38)
// PROD_SUBJECT  VARCHAR2(255 BYTE)
// CREATE_DATE   TIMESTAMP(6)
// CREATE_BY     VARCHAR2(20 BYTE)
// UPDATE_DATE   TIMESTAMP(6)
// UPDATE_BY     VARCHAR2(20 BYTE)
// VERSION       NUMBER(8)
class Model_gms_director_produce extends CI_Model {
	...
	public function __construct() 
	{
		...
		$this->table_name = 'GMS_DIRECTOR_PRODUCE';
		$this->primary_key = 'DI_PROD_ID';
	}
	...
	public function get_all($order_field = 'DI_PROD_ID', $order_type = 'ASC')
	{
	...
	public function fetch_data($limit = '0', $offset = '0', $order_field = 'DI_PROD_ID', $order_type = 'ASC')
	{
	...
	public function fetch_by_member_id($member_id = '0', $limit = '0', $offset = '0', $order_field = 'DI_PROD_ID', $order_type = 'ASC')
	{
		$this->db->from($this->table_name);
		$this->db->where('MEMBER_ID', $member_id);
		$this->db->order_by($order_field, $order_type);
