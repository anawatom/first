...
// DI_EDU_ID      NUMBER(15)
// MEMBER_ID      NUMBER(38)
// EDU_YR         VARCHAR2(4 BYTE)
// EDU_LEVEL      VARCHAR2(80 BYTE)
// EDU_DEPT       VARCHAR2(100 BYTE)
// EDU_INSTITUTE  VARCHAR2(100 BYTE)
// CREATE_DATE    TIMESTAMP(6)
// CREATE_BY      VARCHAR2(20 BYTE)
// UPDATE_DATE    TIMESTAMP(6)
// UPDATE_BY      VARCHAR2(20 BYTE)
// VERSION        NUMBER(8)
class Model_gms_director_edu extends CI_Model {
	...
	public function __construct() 
	{
		...
		$this->table_name = 'GMS_DIRECTOR_EDU';
		$this->primary_key = 'DI_EDU_ID';
	}
	...
	public function get_all($order_field = 'DI_EDU_ID', $order_type = 'ASC')
	{
	...
	public function fetch_data($limit = '0', $offset = '0', $order_field = 'DI_EDU_ID', $order_type = 'ASC')
	{
	...
	public function fetch_by_member_id($member_id = '0', $limit = '0', $offset = '0', $order_field = 'DI_EDU_ID', $order_type = 'ASC')
	{
		$this->db->from($this->table_name);
		$this->db->where('MEMBER_ID', $member_id);
		$this->db->order_by($order_field, $order_type);
...
/* Location: ./application/controllers/model_gms_director_edu.php */